    ...
    <section className="shell py-20 lg:py-36">
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_1fr] lg:gap-24">
        ...
        <Reveal delay={120} className="lg:pt-4">
          <p className="type-body max-w-lg text-lg text-muted-foreground lg:text-xl">
          ...
          <dl className="mt-12 grid grid-cols-2 gap-x-8 gap-y-8 border-t border-border pt-8 sm:grid-cols-3">
            {[
              ["Founded", "2026"],
              ["Made in", "Portugal"],
          ...
          <Link
            href="/about/"
            className="type-meta group mt-12 inline-flex h-14 items-center gap-3 bg-foreground px-8 text-background transition-colors duration-200 hover:bg-primary hover:text-primary-foreground"
          >
            About SLAEGA
