...
export const COLLECTIONS: Collection[] = [
  {
    ...
    name: "Ozali",
    label: "OZALI",
    statement: "OZALI. C'EST TOI.",
    description:
      "The way into the house. Ozali means it is you — the pieces worn without becoming anyone else. Nothing here is a costume.",
  },
  {
    id: "seria",
    name: "Seria",
    label: "SERIA",
    statement: "LE SÉRIEUX SE PORTE.",
    description:
      "Seria is a word made to mean serious. Wearing Seria is being serious, being respected, having the mind for it and knowing what you are doing. Tailoring for men and women — because being serious has no gender.",
  },
  {
    id: "berser-k",
    name: "Berser K",
    label: "BERSER K",
    statement: "AIMER SANS PERMISSION.",
    description:
      "The collection of love, and of the love that is not allowed. Where the rest of the house holds back, Berser K does not.",
  },
  {
    id: "aza-vrai",
    name: "Aza Vrai",
    label: "AZA VRAI",
    statement: "LE LUXE SANS BRUIT.",
    description:
      "Luxury inside SLAEGA's simplicity. The mark is at its quietest here: what costs should be felt, not read.",
  },
  {
    id: "slaega-19",
    name: "SLAEGA 19",
  ...
  {
    id: "king-sedeo-leos",
    name: "King Sedeo Leos",
    label: "KING SEDEO LEOS",
    statement: "",
    description: "",
  },
];
...
const CATALOGUE: Product[] = [
  {
    ...
    name: "SLAEGA Signature Hoodie",
    price: 89000,
    category: "clothing",
    collection: "slaega-19",
    rank: 1,
    ...
    edition: {
      ...
      runSize: 150,
      drop: "SLAEGA 19",
      note: "One of 150. Hand-numbered on a signed satin label at the inner hem, with a matching certificate in the box. The run closes when it sells out — it is not remade.",
    },
    tagline: "Heavyweight loopback. Signed label.",
    description:
      "The Signature Series reading of the hoodie. 500 GSM Japanese loopback, garment dyed in small lots so no two runs match exactly, with a double-layer hood and bound seams throughout. The SLAEGA lockup is embroidered rather than printed — raised, dense, and built to outlast the fabric.",
    ...
    details: [
      { label: "Material", value: "100% Japanese loopback cotton, 500 GSM, garment dyed" },
      { label: "Fit", value: "Oversized. Dropped shoulder, double-layer hood." },
      { label: "Edition", value: "150 pieces, hand-numbered and signed" },
      CARE_COTTON,
      SHIPPING,
      RETURNS,
    ],
  },
  {
    ...
    edition: {
      ...
      runSize: 80,
      drop: "SLAEGA 19",
      note: "Eighty pieces, cut and finished in a single production run. Each carries a numbered brass plate at the inner placket. No restock.",
    },
    tagline: "Waxed cotton. Eighty pieces.",
    description:
      "The heaviest piece in the range. Waxed cotton canvas over a quilted lining, with storm cuffs, a two-way zip and hand-set brass hardware that patinas rather than plates. The mark is embroidered small at the chest; the numbered plate does the talking inside.",
    colors: [OLIVE, BLACK, CLAY],
    sizes: ["S", "M", "L", "XL", "XXL"],
    mockup: {
      type: "jacket",
      logoAsset: "symbol",
    ...
    details: [
      { label: "Material", value: "Waxed cotton canvas, quilted lining, solid brass hardware" },
      { label: "Fit", value: "Regular. Layers over a hoodie." },
      { label: "Edition", value: "80 pieces, numbered brass plate" },
      { label: "Care", value: "Do not wash. Brush clean and re-wax annually." },
      SHIPPING,
      RETURNS,
    ],
  },
  {
    id: "p-numbered-bottle",
    slug: "numbered-bottle",
    name: "SLAEGA Numbered Bottle",
    price: 28000,
    ...
    edition: {
      ...
      runSize: 300,
      drop: "SLAEGA 19",
      note: "Three hundred pieces. Each bottle is laser engraved with its own number beneath the mark, so no two are identical.",
    },
    tagline: "600ml. Engraved number.",
    description:
      "The Everyday Bottle in a finite run. Same double-walled steel and vacuum seal, finished in a stonewashed coating that takes the engraving deeper. The SLAEGA lockup is cut into the shell with the piece's own number below it.",
    colors: [BLACK, STEEL, SAND],
    sizes: ["600 ML"],
    mockup: {
      type: "bottle",
      logoAsset: "lockup",
    ...
    details: [
      { label: "Material", value: "18/8 stainless steel, stonewashed coating" },
      { label: "Capacity", value: "600 ml — 12h hot / 24h cold" },
      { label: "Edition", value: "300 pieces, individually engraved" },
...
/** Limited runs, in the order they lead the shop. */
export const getEditions = (): Product[] =>
  PRODUCTS.filter((p) => p.edition).sort((a, b) => a.rank - b.rank);
