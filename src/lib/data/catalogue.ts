...
export const COLLECTIONS: Collection[] = [
  {
    ...
    statement: "SIGNED. NUMBERED. FINITE.",
    description:
      "Short runs, made once. Each piece is numbered against the size of its run and carries a signed label — when the run is gone it is not remade.",
  },
  {
    id: "drop-01",
    name: "Drop 01",
